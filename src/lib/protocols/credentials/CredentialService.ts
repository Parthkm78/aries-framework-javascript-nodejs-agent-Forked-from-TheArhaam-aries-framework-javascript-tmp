...
export class CredentialService extends EventEmitter {
   ...
   */
  public async getCredentialsForProofReq(proofRequestMessage: ProofRequestMessage): Promise<ProofCred> {
    return await this.wallet.getCredentialsForProofReq(JSON.stringify(proofRequestMessage));
  }
