...
const CredentialService_1 = require("../../credentials/CredentialService");
...
const CredentialState_1 = require("../../credentials/CredentialState");
const StubWallet_1 = require("./StubWallet");
const CredentialOfferMessage_1 = require("../../credentials/messages/CredentialOfferMessage");
const JsonEncoder_1 = require("../../../utils/JsonEncoder");
const CredentialRequestMessage_1 = require("../../credentials/messages/CredentialRequestMessage");
const CredentialResponseMessage_1 = require("../../credentials/messages/CredentialResponseMessage");
const fixtures_1 = require("./fixtures");
const CredentialAckMessage_1 = require("../../credentials/messages/CredentialAckMessage");
const Attachment_1 = require("../../../decorators/attachment/Attachment");
jest.mock('./../../../storage/Repository');
const CredentialRepository = Repository_1.Repository;
const ProofRepository = Repository_1.Repository;
