declare module 'indy-sdk' {
  ...
  export interface Indy {
    ...
    proverCreateProof(wh: WalletHandle, proofReq: string, requestedCredentials: string, masterSecret: string, schemas: string, credentialDefs: string, revStates: string): Promise<Proof>
...
interface Proof {
  requested_proof: Record<string, unknown>;
